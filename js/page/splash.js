...
splashglobal.animation = {
    ...
    args: {
        get copyright() { return copyrightNotice(); },
...
(function () {
    ...
    // For this customer, regardless of whether or not previous orders is enabled, when they scan a barcode to start it should go right to ordering.
    // This is temporary until we get the new splash action working.
    window.skipPreviousOrders = true;
