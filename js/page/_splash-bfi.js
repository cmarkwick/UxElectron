...
splashglobal.animation = {
    ...
    args: {
        ...
        background: _nex.assets.theme.mediaPath() + "images/Background2.png",
        color: "#000000",
        fps: 24,
        width: 1280,
        height: 720
...
console.debug("splash.js media path:");
...
(function (lib, img, cjs, ss, args) {
    ...
    (lib.instructionloop = function (mode, startPosition, loop) {
        ...
        var txt = new createjs.Text(args.message(0), "54px brandon", "#000000");
        txt.name = "txtMessage";
        ...
        //.to({ alpha: 1.0, text: args.message(1) }, 0).wait(61).to({ alpha: 0.0 }, 8)
        //.to({ alpha: 1.0, text: args.message(2) }, 0).wait(61).to({ alpha: 0.0 }, 8);
        // Add additional messages if applicable
